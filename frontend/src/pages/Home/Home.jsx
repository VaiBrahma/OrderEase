  ...
  return (
    <>
      ...
      <div className="border-[1px] border-[#8686862c] m-2 md:m-auto gap-4 rounded-lg p-8 max-w-3xl text-center flex bg-[#0000009a] flex-col justify-center items-center" style={{ backdropFilter: 'blur(10px)' }}>
        ...
        <p className="text-white">Already have an account? <button onClick={handleLoginClick} className="active:scale-[0.9] active:text-blue-300 text-blue-500">Login</button></p>
      </div>
      {login && <div ref={loginRef} className="mb-[50px]"><Login /></div>}
    </>
  );
};
