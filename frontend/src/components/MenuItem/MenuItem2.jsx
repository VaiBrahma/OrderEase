  ...
  return (
    <div className={`${styles.card} w-[100%]`}>
      <div
        ...
        style={{
          background: `url(${image_src || "/images/defaultFoodIcon.jpeg"}) no-repeat center center/cover`,
        }}
      ></div>
        ...
        {isEditing ? (
          <form onSubmit={handleSave}>
            <div className="flex flex-col gap-2">
              ...
              <select
                ...
                onChange={(e) => setEditVegetarian(e.target.value)}
              >
              ...
              <div className={styles.buttons}>
                <button
                  type="submit"
                  className="my-1.5 mx-1 px-2 bg-[#00000049] rounded-md shadow-md hover:bg-black"
                >
                  Save
                </button>
                <button
                  onClick={handleCancel}
                  className="my-1.5 px-2 bg-[#00000049] rounded-md shadow-md hover:bg-black"
                >
                  Cancel
                </button>
              </div>
          ...
          <>
            ...
            <div className={styles.price}>
              <span className="text-[#ffffff61]">Price:</span> ₹{price} /-
            </div>
            {isButtonNeeded && (
              <div className={styles.buttons}>
